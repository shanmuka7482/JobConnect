  ...
  return (
    <>
      ...
      <div className={`${IsMenuOpen ? "" : "hidden"}`}>
        <aside
          id="default-sidebar"
          class="fixed  left-0 z-40 w-54 h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
            ...
            <ul class="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap">Edit Jobs</span>
                </a>
              </li>
              <li>
                <a
                  href="/Dashboard/PostJobs"
                  class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group"
                >
                  <svg
                    class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 "
